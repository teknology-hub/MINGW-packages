...
- [mingw-w64-tek-injector](https://github.com/teknology-hub/tek-injector), with a `-dist` split package that provides official statically linked release binaries
